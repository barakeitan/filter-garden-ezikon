...
local dead_reckoning_parameters = {
  ...
  { name = "padding", data_type="padding", bit_count = 120 },
  { name = "entity_linear_acceleration", data_type="linear_acceleration_t" },
  { name = "entity_angular_velocity", data_type="angular_velocity_t" }
}
